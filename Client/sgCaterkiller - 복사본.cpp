...
namespace sg
{
	...
	void Caterkiller::OnCollisionEnter(Collider* other)
	{
		...
		{
			if (mAni->GetAniIndex(L"ck_move_left") == 1
				|| mAni->GetAniIndex(L"ck_move_left") == 2
				|| mAni->GetAniIndex(L"ck_move_left") == 3
				|| mAni->GetAniIndex(L"ck_move_left") == 4
				|| mAni->GetAniIndex(L"ck_move_left") == 10
				...
				|| mAni->GetAniIndex(L"ck_move_right") == 1
				|| mAni->GetAniIndex(L"ck_move_right") == 2
				|| mAni->GetAniIndex(L"ck_move_right") == 3
				|| mAni->GetAniIndex(L"ck_move_right") == 4
