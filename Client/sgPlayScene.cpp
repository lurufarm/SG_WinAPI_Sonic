...
namespace sg
{
	...
	void PlayScene::Initialize()
	{
		...
		{
			object::Instantiate<Backgroundsea>(Vector2(4000 + i, 2927), eLayerType::BG, eSceneType::Play);
		}
		...
		object::Instantiate<Ring>(Vector2(2300, 3460), eLayerType::Ring, eSceneType::Play);
